...
public class SensorActor extends AbstractFSM<DeviceState, SensorData> {
    ...
    public static Props props(final String eui, String city, double latitude, double longitude,
        ...
        return Props.create(new Creator<SensorActor>() {
            ...
            public SensorActor create() throws Exception {
                return new SensorActor(eui, city, latitude, longitude, timeout);
            }
        });
    }
    ...
    public SensorActor(final String eui, String city, double latitude, double longitude, FiniteDuration timeout) {
        log().info("Constructor called with type: {}, eui: {}, lat: {}, lon: {}", city, eui, latitude, longitude);
        this.initialData = new SensorData(eui, city, latitude, longitude, timeout);
